...
### ✨ 新增
- **Kuroneko Auth SDK 登录**：使用统一的认证服务登录
- **长期 Refresh Token**：登录有效期从 15 分钟延长至 7-30 天
- **复习系统鉴权**：review-app 接入线上认证系统

### 🔧 修复
- ✅ **修复 "was" 被标记为生词**：常见词优先级检查置于最高
- ✅ **修复内容脚本 Token 同步**：登录后自动刷新页面处理

### 📦 部署
- 更新后端 vocabulary.js（常见词判断优化）
- 更新 review-app（SDK 登录）
- 添加服务监控页面
